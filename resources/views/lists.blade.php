@extends('main')
@section('title', 'Wood Calculator')
@section('content')
<div class="nk-block nk-block-lg l">
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="nk-block-title">Wood Lists</h4>
        </div>
    </div>
            ...
            <table class="table table-striped m-0 nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col tb-col-mb"><span class="sub-text">Thick</span></th>
                        <th class="nk-tb-col tb-col-mb"><span class="sub-text">Width</span></th>
